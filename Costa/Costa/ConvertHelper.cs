...
namespace Costa
{
    internal static class ConvertHelper
    {
        ...
        {
            return ((IEnumerable<object>) obj).Cast<T>().ToArray();
        }

        public static List<T> GetListFromObjectList<T>(object obj)
        {
            return ((IEnumerable<object>) obj).Cast<T>().ToList();
        }
        ...
        public static T ToTypedVariable<T>(object obj)
        {
            ...
            if (type.IsArray)
            {
                dynamic dynamicResult = typeof(ConvertHelper)
                    .GetMethod(nameof(GetArrayFromObjectList))
            ...
            {
                dynamic dynamicResult = typeof(ConvertHelper)
                    .GetMethod(nameof(GetListFromObjectList))
